    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-400">Ubah informasi data wali kelas</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-slate-900/80 backdrop-blur-sm rounded-2xl border border-slate-800 overflow-hidden shadow-xl">
                <div class="p-8">
                    ...
                    <form method="POST" action="{{ route('admin.wali-kelas.update', $waliKelas->id) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input id="nama_lengkap" 
                                           ...
                                           type="text" 
                                           name="nama_lengkap" 
                                           value="{{ old('nama_lengkap', $waliKelas->nama_lengkap) }}" 
                                ...
                                <div>
                                    ...
                                    <select id="jenis_kelamin" name="jenis_kelamin" class="block w-full rounded-xl bg-slate-800/50 border border-slate-700 text-slate-200 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all duration-200 text-sm px-4 py-2.5" required>
                                        <option value="L" @selected(old('jenis_kelamin', $waliKelas->jenis_kelamin) == 'L') class="bg-slate-800">Laki-laki</option>
                                        <option value="P" @selected(old('jenis_kelamin', $waliKelas->jenis_kelamin) == 'P') class="bg-slate-800">Perempuan</option>
                                    </select>
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input id="email" 
                                           ...
                                           type="email" 
                                           name="email" 
                                           value="{{ old('email', $waliKelas->user->email) }}" 
