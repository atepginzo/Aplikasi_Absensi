<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.kelas.index') }}" class="inline-flex items-center px-4 py-2 text-sm font-semibold text-slate-200 bg-slate-800/70 border border-slate-700 rounded-xl hover:bg-slate-700/70 transition">
