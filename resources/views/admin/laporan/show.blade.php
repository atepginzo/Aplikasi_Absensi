                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                            <thead class="bg-slate-900/60">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-center font-semibold text-slate-400 uppercase tracking-wide">Total Input</th>
                    ...
                    <div class="sm:hidden p-4 space-y-3">
                        @foreach ($rekapKehadiran as $rekap)
                            <div class="rounded-xl border border-slate-800 bg-slate-900/70 p-4">
                                ...
                                <a href="{{ route('admin.laporan.detail', ['kelas' => $kelas->id, 'tanggal' => $rekap->tanggal]) }}" class="w-full inline-flex items-center justify-center px-4 py-2 text-sm font-semibold rounded-xl border border-slate-700 text-slate-200 hover:border-sky-500 hover:text-sky-300 transition">
                                    Lihat Detail
